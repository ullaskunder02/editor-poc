...
"[project]/node_modules/.pnpm/editorjs-drag-drop@1.1.16/node_modules/editorjs-drag-drop/dist/bundle.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
    ...
    ("TURBOPACK compile-time truthy", 1) ? module.exports = t() : "TURBOPACK unreachable";
        ...
        var e = {
            523: (e, t, r)=>{
                ...
                var n = r(601), o = r.n(n), i = r(314), a = r.n(i)()(o());
                a.push([
                    e.id,
            ...
            72: (e)=>{
                ...
                function n(e, n) {
                    for(var i = {}, a = [], c = 0; c < e.length; c++){
                        var s = e[c], l = n.base ? s[0] + n.base : s[0], u = i[l] || 0, d = "".concat(l, " ").concat(u);
                        i[l] = u + 1;
                        var f = r(d), p = {
                            css: s[1],
                            media: s[2],
        ...
        return (()=>{
            ...
            var e = r(72), t = r.n(e), o = r(825), i = r.n(o), a = r(659), c = r.n(a), s = r(56), l = r.n(s), u = r(540), d = r.n(u), f = r(113), p = r.n(f), v = r(523), y = {};
            function h(e) {
            ...
            y.styleTagTransform = p(), y.setAttributes = l(), y.insert = c().bind(null, "head"), y.domAPI = i(), y.insertStyleElement = d(), t()(v.A, y), v.A && v.A.locals && v.A.locals;
            var g = function() {
                return e = function e(t, r) {
                    var n = t.configuration, o = t.blocks, i = t.toolbar, a = t.save;
                    !function(e, t) {
                        if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
                    }(this, e), this.toolbar = i, this.borderStyle = r || "1px dashed #aaa", this.api = o, this.holder = "string" == typeof n.holder ? document.getElementById(n.holder) : n.holder, this.readOnly = n.readOnly, this.startBlock = null, this.endBlock = null, this.save = a, this.setDragListener(), this.setDropListener();
                }, r = [
                    {
                ...
                ], (t = [
                    {
                        ...
                        value: function(e) {
                            if (e) {
                                var t = document.createRange(), r = window.getSelection();
                                t.setStart(e.childNodes[0], 0), t.collapse(!0), r.removeAllRanges(), r.addRange(t), e.focus();
                            }
                        }
                    },
                    {
                        ...
                        value: function() {
                            ...
                            if (!this.readOnly) {
                                ...
                                if (t) this.initializeDragListener(t);
                                    ...
                                    var r = new MutationObserver(function(t, r) {
                                        var n = e.holder.querySelector(".ce-toolbar__settings-btn");
                                        n && (e.initializeDragListener(n), r.disconnect());
                                    });
                                    r.observe(this.holder, {
                                        childList: !0,
                                        subtree: !0
                                    });
                                }
                        ...
                        value: function(e) {
                            ...
                            e.setAttribute("draggable", "true"), e.addEventListener("dragstart", function() {
                                ...
                                if (t.toolbar.close(), !t.isTheOnlyBlock()) {
                                    var e = t.holder.querySelectorAll(".ce-block"), r = t.holder.querySelector(".ce-block--drop-target");
                                    t.setElementCursor(r), t.setBorderBlocks(e, r);
                                }
                            });
                        }
                    },
                    {
                        ...
                        value: function(e, t) {
                            ...
                            Object.values(e).forEach(function(n) {
                                ...
                                n !== t ? (o.style.removeProperty("border-top"), o.style.removeProperty("border-bottom")) : Object.keys(e).find(function(r) {
                                    return e[r] === t;
                                }) > r.startBlock ? o.style.borderBottom = r.borderStyle : o.style.borderTop = r.borderStyle;
                            });
                        }
                    },
                    {
                        ...
                        value: function() {
                            ...
                            document.addEventListener("drop", function(t) {
                                ...
                                if (e.holder.contains(r) && null !== e.startBlock) {
                                    ...
                                    if (n) {
                                        var o = n.querySelector(".ce-block__content");
                                        o.style.removeProperty("border-top"), o.style.removeProperty("border-bottom"), e.endBlock = e.getTargetPosition(n), e.moveBlocks();
                                    }
                                }
                                e.startBlock = null;
                            });
                ...
                ]) && b(e.prototype, t), r && b(e, r), Object.defineProperty(e, "prototype", {
                    writable: !1
                }), e;
...
//# sourceMappingURL=c62a8_editorjs-drag-drop_dist_bundle_c33bb82c.js.map