...
"[project]/node_modules/.pnpm/editorjs-subscript@0.0.5/node_modules/editorjs-subscript/dist/bundle.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
        ...
        function(t, e) {
            ...
            var i = function() {
                function t(e) {
                    ...
                    }(this, t), this.api = n, this.button = null, this.tag = "SUB", this.iconClasses = {
                ...
                return o(t, null, [
                    ...
                    },
                    {
                        ...
                        value: function(t) {
                            if (t) {
                                var e = this.api.selection.findParentTag(this.tag);
                    ...
                    },
                    {
                        ...
                        value: function(t) {
                            ...
                            var e = window.getSelection(), n = e.getRangeAt(0), o = n.extractContents();
                    ...
                    },
                    {
                        key: "checkState",
                        value: function() {
                            var t = this.api.selection.findParentTag(this.tag);
...
//# sourceMappingURL=db54c_editorjs-subscript_dist_bundle_fc072de7.js.map